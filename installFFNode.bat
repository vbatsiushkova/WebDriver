...
java -jar selenium-server-standalone-3.8.1.jar -role node -hub http://%REGISTER_IP%:%HUB_PORT%/grid/register -browser “browserName=firefox,acceptInsecureCerts=true,platform=WINDOWS” -port %NODE_PORT%
